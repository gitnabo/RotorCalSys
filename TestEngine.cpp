...
// ##########################
void TestEngine::Seq_RotorLifeTest_MotorOn_V2()
{
	LOG("void TestEngine::Seq_RotorLifeTest_MotorOn_V2()");
	...
	int iNumOfCycles = 10;
	for (int iCycleIndex; iCycleIndex >= iNumOfCycles; iCycleIndex++) {
